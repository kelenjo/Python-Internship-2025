...
class AddTourForm(FlaskForm):
    ...
    country = StringField("Country", validators=[DataRequired(message="Please enter a country"), length(max=50)])
    description = StringField("Description", validators=[DataRequired(message="Please enter a description")])
    price = IntegerField("Current Price",
                         validators=[DataRequired(message="Please enter the price")])
    old_price = IntegerField("Old Price", validators=[DataRequired(message="Please enter the old price")], default=0.0)
